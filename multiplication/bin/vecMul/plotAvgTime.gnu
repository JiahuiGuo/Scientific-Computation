...
set title "Average Performance analysis of vector and matrix multiplication"
set xlabel "Size of the vector."
set ylabel "Average time (sec)"
set style data linespoints
set output 'timingVecMulAvg.png'
plot  "avgVecMul.txt" using 1:2  title "Average Time"
